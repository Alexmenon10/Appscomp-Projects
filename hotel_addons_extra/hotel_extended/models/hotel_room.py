...
class RoomReservationSummary(models.Model):
    ...
    room_categ_id = fields.Many2many(
        "hotel.room.type", string="Room Category", ondelete="restrict"
    )
    ...
    @api.onchange("date_from", "date_to","room_categ_id")  # noqa C901 (function is too complex)
    def get_room_summary(self):  # noqa C901 (function is too complex)
        ...
        if self.date_from and self.date_to:
            ...
            domain = [('room_categ_id', '=', self.room_categ_id.ids)]
